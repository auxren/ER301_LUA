...
local AliasingTriangleUnit = Class{}
AliasingTriangleUnit:include(Unit)

function AliasingTriangleUnit:init(args)
  args.title = "Aliasing Triangle"
  args.mnemonic = "Tr"
  Unit.init(self,args)
end

function AliasingTriangleUnit:onLoadGraph(pUnit,channelCount)
...
function AliasingTriangleUnit:loadMonoGraph(pUnit)
  -- create objects
  local osc = self:createObject("TriangleOscillator","osc")
...
function AliasingTriangleUnit:loadStereoGraph(pUnit)
  self:loadMonoGraph(pUnit)
...
function AliasingTriangleUnit:onLoadViews(objects,controls)
...
function AliasingTriangleUnit:deserialize(t)
